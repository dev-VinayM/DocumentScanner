...
public class ResultFragment extends Fragment {
    ...
    private View view;
    private TouchImageView scannedImageView;
    ...
    private void init() {
        scannedImageView = (TouchImageView) view.findViewById(R.id.scannedImage);
    ...
    private Bitmap getBitmap() {
        ...
        try {
            ...
            bitmapFileName = original.getConfig().name();
            ...
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Utils.storeBitmap(getActivity(), bitmap);
